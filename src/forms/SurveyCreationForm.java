...
public class SurveyCreationForm 
{
	...
	public Survey setNewSurvey(HttpServletRequest request)
	{
		...
		try 
		{
	        subjectValidation(request, sSubject );
	    } 
		catch ( Exception e ) 
		{
	...
	private void subjectValidation(HttpServletRequest request, String sSubject ) throws Exception 
    {
        if ( sSubject != null ) 
        {
	...
	public void setErrors(String sField, String sMessage)
    {
